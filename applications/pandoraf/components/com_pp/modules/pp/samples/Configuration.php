...
class Configuration
{
	...
	public static function getAcctAndConfig()
	{
		$config = array(
				...
				"acct1.UserName" => "mohuahuan-facilitator_api1.yahoo.com",
				"acct1.Password" => "FSUWX6JYMEWSMJJR",
				"acct1.Signature" => "AFcWxV21C7fd0v3bYYYRCpSSRl31A-YJQq-DDN7NoUjl-u5EOblfg60.",
